...
include("header.php"); ?>
	...
	<ol class="breadcrumb">
                <center><li class="breadcrumb-item"><h4><a href="">Add User</a></h4></li></center>
            </ol>
<!--grid-->
...
<?php
		...
		$result = mysql_query("SELECT * FROM usertbl WHERE email='$email'");
        $data = mysql_num_rows($result);
        if(($data)==0){
		
		$query="insert into usertbl(uid,fname,lname,gender,blood,email,phone,mobile,password,cpassword,dob,address,deptname,catname,file) values('','$fname','$lname','$gender','$blood','$email','$phone','$mobile','$password','$cpassword','$dob','$address','$deptname','$catname','$userprofile')";
